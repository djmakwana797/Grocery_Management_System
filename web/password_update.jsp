<%-- 
    ...
    Created on : 2 Mar, 2021, 1:31:27 PM
                ...
                <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                    <div class="col-first">
                        ...
                        <nav class="d-flex align-items-center">
                            ...
                            <a href="login.jsp">Update Password</a>
                        </nav>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="login_form_inner">
                            ...
                            <form class="row login_form" action="updated_pw.jsp" method="post" id="login_form_update">
                                ...
                                <div class="col-md-12 form-group">
                                    <input type="password" class="form-control" id="userconfPassword" name="userconfPassword" placeholder="Confirm Password"
                                           onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
                                    <p id="p3"></p>
                                </div>
                                <div class="col-md-12 form-group">
                                    <button type="submit" value="submit" class="primary-btn" style="margin-bottom: 16px">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
